    ...
    <section class="py-10 bg-gray-50 font-poppins dark:bg-gray-800 rounded-lg">
      ...
      @endforeach
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
              <div>
                <div class="font-semibold text-blue-400">{{ Number::currency($price_range, 'BGN') }}</div>
                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                  max="15000" value="15000" step="100">
                <div class="flex justify-between ">
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(100,'BGN')}}</span>
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(15000,'BGN')}}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="border border-gray-300 dark:border-gray-700">
            ...
            <p class="text-lg ">
              <span
              class="text-green-600 dark:text-green-600">{{Number::currency($product->price, 'BGN')}}</span>
            </p>
            </div>
            ...
            <a wire:click.prevent="addToCart({{ $product->id }})" href="#"
              ...
              </svg><span wire:loading.remove>Add to Cart</span><span wire:loading wire:target="addToCart({{ $product->id }})">Loading...</span>
            </a>
